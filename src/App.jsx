    ...
    <div className="d-flex flex-column min-vh-100 bg-light">
      <nav className="app-header navbar navbar-dark">
        <div className="container-fluid">
          ...
          <div className="cart-icon" aria-label={`${totalItems} items in basket`}>
            <svg xmlns="http://www.w3.org/2000/svg" width="26" height="26" fill="white" viewBox="0 0 16 16" aria-hidden="true">
            ...
            {totalItems > 0 && (
              <span className="cart-count badge bg-danger">{totalItems}</span>
            )}
          </div>
        </div>
      </nav>
